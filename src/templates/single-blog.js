		...
		<meta property="twitter:description" content={blog.edges[0].node.yoast.twitter_description}></meta>
           ...
           <section className="breadcumbs-section text-center">
              <div className="container">
                <h2 className="heading-main text-center text-white">Our Blog</h2>
            ...
            <div className="container">
                ...
                <div className="row">
                  ...
                  <div className="pl-0 pt-4 pr-0 pl-sm-4 pt-sm-4 pr-md-4 pb-md-4  pb-0">
                        <p className="sub-heading text-center ">{blog.edges[0].node.date}</p>
                        <h1 className="section-heading mt-2 mb-2 mt-md-2 mb-md-2 text-center" dangerouslySetInnerHTML={{ __html: blog.edges[0].node.title}}></h1>
