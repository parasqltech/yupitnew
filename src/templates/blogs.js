...
class demopage extends Component {
  render() {
    ...
    return (
		<Layout>
			<Helmet>
				<title>YupiT: Blog for the Tasty recipes and venue secrets</title>
				<meta name="title" content="YupiT: Blog for the Tasty recipes and venue secrets"></meta>
				<meta property="og:title" content="YupiT: Blog for the Tasty recipes and venue secrets"></meta>
				<meta property="twitter:title" content="YupiT: Blog for the Tasty recipes and venue secrets"></meta>
        venue
				
				<meta name="description" content="Get latest updates about the new recipes and other secrets of the venue. Read YupiT blog and join Newsletter today."></meta>
				<meta property="og:description" content="Get latest updates about the new recipes and other secrets of the venue. Read YupiT blog and join Newsletter today."></meta>
				<meta property="twitter:description" content="Get latest updates about the new recipes and other secrets of the venue. Read YupiT blog and join Newsletter today."></meta>
               ...
               <div className="row">
					...
					{(this.props.pageContext.nextPagePath != "") ? (<Link className="btn btn-default" to={this.props.pageContext.nextPagePath}>Next</Link>) : (<Link className="btn btn-primary invisible" to={this.props.pageContext.nextPagePath}>Next</Link>)}
                        ...
                        <div className="col-md-4">
                            ...
                            <div className="sidebar-widget bg-light d-none d-md-block">
                                <Searchbox />
                            </div>
