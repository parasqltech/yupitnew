...
const Paymentthankyou = () => (
  ...
  <Layout>
      ...
      <section className="thank-you-page-section payment-page p-4">
        ...
        <div className="row justify-content-center">
          ...
          <div className="row justify-content-center">
            <div className="col-xl-8">
              <h1 className="section-heading font-weight-bold mb-2">Thank You</h1>
              <p className="label-text-2"> Thanks for subscribing to our membership plan. You should receive a confirmation email soon.</p>
              <p className="label-text-2 text-dark font-weight-semi-bold">Order transition ID is YupiT2513</p>
              <Link to="/" className="btn btn-default mt-0 pl-4 pr-4 mb-2">Get the app</Link>  
            </div>
          </div>
        </div>
    </section>
