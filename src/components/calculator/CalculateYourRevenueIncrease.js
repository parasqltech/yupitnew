			...
			<div className="row justify-content-start">
              ...
              {data &&
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6 mb-4">
                            <label className="">Maximum Capacity Per Hour*</label>
                            <input type="text" value={this.state.restaurant_d_capacity} onChange={this.setRDC} placeholder="" className="form-control"required/>
							{this.validator.message('Maximum Capacity Per Hour', this.state.restaurant_d_capacity, 'required|numeric|min:1|max:100')}
                        </div>
                        <div className="col-md-6 mb-4">
