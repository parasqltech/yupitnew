                    ...
                    return (
                        <section className="imbusiness-section-6">
                          <div className="container">
                              <h2 className="section-heading text-center">{prop.node.acf.our_features_section_heading}</h2>
                              <div className="row d-flex justify-content-between">
                                    <div className="col-lg-4 col-md-12 mb-md-0 mb-4 text-center">
                                    <div className="FeatureSlider">
                                        {/* <span className="mobileTime"><Clock format={'HH:mm'} ticking={true} timezone={'Australia/Perth'} /></span> */}
                                        <span className="mobileTime">11 : 11</span>
                                              ...
                                              {prop.node.acf.feature_list.map(
                                                  ...
                                                  return (
                                                      ...
                                                      <div className="text-md-left text-center">
                                                          ...
                                                          <img src={prop1.feature_icon.localFile.childImageSharp.fixed.base64} className="img-fluid d-inline " alt=""/>
                                                          </div>
                                                          <h4 className="section-heading-3 font-weight-semi-bold text-primary">{prop1.feature_title}</h4>
