...
class WhitePaper extends React.Component {
  constructor(props) {
	...
	handlepopup = event => {
		window.open('https://webapi.yupit.io/download.php');
	}
		...
		if(this.validator.allValid()) {
			...
			request.onreadystatechange = function() {
				if(request.readyState == XMLHttpRequest.DONE) {
					...
					//document.getElementsByClassName("democlass")[0].click();
					document.getElementById("democlass").click(); 
...
render() {
  return(
      <>
        ...
        <a id="democlass" onClick={this.handlepopup}  ></a>
			...
			<div>   
                    ...
                    <div className="row">
                        <div className="col-md-12 mb-4">
							...
							{this.validator.message('Venue Name', this.state.restaurant_name, 'required')}
							
                        </div>
                       <div className="col-md-12 mb-4">
                            <label className="">Venue Address*</label>
							...
							{this.validator.message('Venue Address', this.state.restaurant_add, 'required')}
